    ...
    <div class="row">
      <div class="col-12">
        <div class="text-center">
          ...
          <h3 class="h2 mb-2">Thanks for contacting us we will reach you out soon.</h3>


<?php
if(isset($_SESSION['success_message'])){
    if(is_array($_SESSION['success_message'])){
        foreach($_SESSION['success_message'] as $messagsuu){
            echo '<p class="mb-5">'.$messagesuu.'</p>';
        }
    } else {
        echo '<p class="mb-5">'.$_SESSION['success_message'].'</p>';
    }
}else{
